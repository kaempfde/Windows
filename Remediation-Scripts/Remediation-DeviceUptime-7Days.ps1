...
$LogoImageUri = "https://play.google.com/store/apps/details?id=de.vonovia.employee.app&hl=gsw"
...
$AttributionText = "Vonovia IT"
$HeaderText = "Ein Computer neustart wird empfohlen!"
$TitleText = "Ihr Gerät wurde innerhalb der letzten $($Uptime.OsUptime.Days) tage nicht neugestartet."
$BodyText1 = "Aus Performance und Stabilitätgründen empfehlen wir einen Neustart mind. einmal die Woche."
$BodyText2 = "Bitte speichern Sie Ihre Arbeit und starten Sie ihr Gerät neu. Vielen Dank im Voraus."
